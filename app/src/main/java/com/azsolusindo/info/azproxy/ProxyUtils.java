...
// Code By mcxiaoke from Github

public class ProxyUtils {
    public static final String LOG_TAG = ProxyUtils.class.getSimpleName();

        public static boolean setProxy(WebView webview, String host, int port, final Class<?> appClass) {
            // 3.2 (HC) or lower
            ...
            // 4.4 (KK)
                ...
                return setProxyKK(webview, host, port, appClass.getName());
            }
        }
